...
ADMIN_MODULES: dict[str, AdminModule] = {
    "overview": AdminModule(
        "overview",
        "Overview",
        "/console/admin",
        "space_dashboard",
        "System summary and first-run posture.",
    ),
    "health": AdminModule(
        "health",
        "Health",
        ...
        "health_and_safety",
        "Operational health, coherence, and system posture.",
    ),
    "cost": AdminModule(
        "cost",
        "Cost",
        "/console/admin/cost",
        "payments",
        "Generation cost, token usage, budgets, and price governance.",
    ),
    "flywheel": AdminModule(
        "flywheel",
        "Flywheel",
        "/console/admin/flywheel",
        "autorenew",
        "Feedback-derived evaluation quarantine and review.",
    ),
    "embedding": AdminModule(
        "embedding",
        "Embedding",
        "/console/admin/embedding",
        "swap_horiz",
        "Embedding profile and index-swap lifecycle.",
    ),
    "providers": AdminModule(
        ...
        "dns",
        "Generation providers, models, endpoints, and verification.",
    ),
    "uploads": AdminModule(
        "uploads",
        "Upload Documents",
        "/console/admin/uploads",
        "upload_file",
        "Direct file onboarding and indexing progress.",
    ),
    "sources": AdminModule(
        "sources",
        "Sources",
        ...
        "description",
        "Source inventory and source-level controls.",
    ),
    "connectors": AdminModule(
        "connectors",
        "Connectors",
        "/console/admin/connectors",
        "hub",
        "Database connector setup and review.",
    ),
    "actions": AdminModule(
        "actions",
        "Actions",
        ...
        "approval",
        "Approvals, tools, and feedback review.",
    ),
    "corpora": AdminModule(
        "corpora",
        "Corpora",
        "/console/admin/corpora",
        "folder_shared",
        "Corpus registry and source assignment.",
    ),
    "jobs": AdminModule(
        "jobs", "Jobs", "/console/admin/jobs", "work_history", "Ingestion queue and job controls."
    ),
    "profiles": AdminModule(
        "profiles",
        "Profiles",
        "/console/admin/profiles",
        "account_circle",
        "Runtime profile activation.",
    ),
    "evals": AdminModule(
        "evals", "Evals", "/console/admin/evals", "analytics", "Retrieval quality reports."
    ),
    "traces": AdminModule(
        "traces",
        "Traces",
        ...
        "timeline",
        "Retrieval traces and query debug.",
    ),
    "policies": AdminModule(
        "policies",
        "Policies",
        "/console/admin/policies",
        "policy",
        "Retrieval and corpus policy visibility.",
    ),
    "access": AdminModule(
        "access",
        "Access",
        ...
        "shield_lock",
        "ACL and access request administration.",
    ),
    "audit": AdminModule(
        "audit",
        "Audit Log",
    ...
    "tuning": AdminModule(
        ...
        "/console/admin/profiles",
        "tune",
        "Candidate tuning, cache, and query mining operations.",
    ),
    "governance": AdminModule(
        "governance",
        "Governance",
        "/console/admin/actions",
        "gavel",
        "Restrictions and abuse governance.",
    ),
}
