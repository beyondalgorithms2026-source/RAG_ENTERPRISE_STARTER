...
- [docs/reuse_inventory.md](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/docs/reuse_inventory.md)
- [docs/extraction_map.md](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/docs/extraction_map.md)
- [docs/rag_poc_v1_assumptions.md](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/docs/rag_poc_v1_assumptions.md)
...
- [backend/app/db/migrate.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/app/db/migrate.py)

Schema source:
- [backend/app/db/schema.sql](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/app/db/schema.sql)
...
- [backend/tests/test_smoke_baseline.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/tests/test_smoke_baseline.py)
- [backend/tests/test_smoke_enrichment.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/tests/test_smoke_enrichment.py)
- [backend/tests/test_smoke_router_compare_eval.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/tests/test_smoke_router_compare_eval.py)
- [backend/tests/smoke_test_extracted.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/tests/smoke_test_extracted.py) as the thin aggregator
...
- [backend/app/ingestion/jobs.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/app/ingestion/jobs.py)
- [backend/app/ingestion/chunking.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/app/ingestion/chunking.py)
- [backend/app/adapters/](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/app/adapters)

Retrieval issues:
- [backend/app/core_rag/retrieval.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/app/core_rag/retrieval.py)
- [backend/app/db/repo_search.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/app/db/repo_search.py)
- [backend/app/core_rag/query_router.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/app/core_rag/query_router.py)

Enrichment/graph/temporal issues:
- [backend/app/ingestion/enrichment.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/app/ingestion/enrichment.py)
- [backend/app/graph/](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/app/graph)
- [docs/internal_metadata_contracts.md](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/docs/internal_metadata_contracts.md)

Ask/compare issues:
- [backend/app/core_rag/answering.py](/path/to/local_dev/RAG%20workflow/RAG_MM_MASTER_POC/backend/app/core_rag/answering.py)
